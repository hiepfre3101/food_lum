...
<body onload="loadTotal()">
    <nav class="navbar navbar-expand-lg  container-fluid px-lg-5 py-lg-4 bg-white " id="header-menu">
        <div class="container-fluid">
            <a class="navbar-brand w-10 d-flex justify-content-center " href="?ctr=home"><img src="./public/img/logo.png" alt="logo" class="img-fluid"></a>
            ...
            <div class="offcanvas offcanvas-end navbar-collapse ms-5 justify-content-between" id="offcanvasNavbar" tabindex="-1" aria-labelledby="offcanvasExampleLabel">
                ...
                <div class="offcanvas-body w-100">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item me-3 d-flex justify-content-between mb-5 mb-lg-0 py-5 py-lg-0 nav-sm">
                            <a class="py-5 py-lg-0 nav-link text-upercase fw-bold fs-2 text-dark header-link" aria-current="page" href="?ctr=menu">Thực đơn</a>
                            <img src="./public/img/slider3.jpg" alt="..." class="d-lg-none w-30 rounded-3 ms-3">
                        </li>
                        <li class="nav-item me-3  d-flex justify-content-between mb-5 mb-lg-0 py-5 py-lg-0 nav-sm">
                            <a class="py-5 py-lg-0 nav-link text-upercase fw-bold fs-2 text-dark header-link" aria-current="page" href="?ctr=voucher">Khuyến mãi</a>
                            <img src="./public/img/slider3.jpg" alt="..." class="d-lg-none w-30 rounded-3 ms-3">
                        </li>
                    </ul>
                        ...
                        <div class="fa-solid fa-circle-user fs-1 px-3 d-none d-lg-block text-dark icon-user position-relative" role="button">
                            <div class="menu-child  bg-primary position-absolute p-3">
                                ...
                                <?php if (isset($_SESSION['idUser'])) { ?>
                                    ...
                                    <?php } ?>
                                    <a href="?ctr=logout" class="text-dark fs-4 fw-semibold link-child" onclick="deleteCart()">Đăng xuất</a>
                                <?php } else { ?>
                    ...
                    <li class="nav-item me-3 d-flex justify-content-between mb-5 mb-lg-0 py-5 py-lg-0 nav-sm d-lg-none">
                        <a class="py-5 py-lg-0 nav-link active text-upercase fw-bold fs-2 text-dark" aria-current="page" href="?ctr=cart">Giỏ hàng</a>
